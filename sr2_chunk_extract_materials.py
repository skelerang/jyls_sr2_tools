...
# --- Materials --- #
    ...
    export_mats = []
    for i in range(len(chunk_materials)):
        mat = chunk_materials[i]
        textures = []
        for tex in mat.textures:
            texname = chunk_texlist[tex]
            texname += "_0.png"    # because chunkpegtool
            textures.append(texname)
        export_mats.append(textures)

    utils.modelhandler.export_mtl(export_mats, export_mtl_path)
