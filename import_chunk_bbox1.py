...
# --- Unknown 11 --- #
    ...
    # 64B
    for _ in range((Unk11f2_count)): # Unk11f_count +1
        f.read(64)
...
class ImportSomeData(Operator, ImportHelper):
    ...
    def execute(self, context):
        if self.type == 'FILE':
            ...
            for chunk in chunks:
                read_some_data(context, os.path.join(dirname, chunk), self.ImportProps, self.ImportMesh, self.ImportCityObjs)
        return {'FINISHED'} 
