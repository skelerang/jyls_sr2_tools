chunk_pc_import_mesh0.py:    This imports models from the chunk, it's probably the one you're after. Warning: Works on some chunks, causes Blender to crash on others.
